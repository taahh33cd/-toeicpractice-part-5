...
let newQs = JSON.parse(fs.readFileSync('scratch/test9_generated.json', 'utf8'));

// Update grammar_type
newQs = newQs.map(q => {
    q.grammar_type = "Danh từ & Đại từ";
    return q;
});
