...
let newQs = JSON.parse(fs.readFileSync('scratch/test4_comparison.json', 'utf8'));

// Update grammar_type
newQs = newQs.map(q => {
    q.grammar_type = "So sánh";
    return q;
});
