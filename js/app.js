...
const TABS = [
  ...
  { id: 'Nhận dạng hậu tố', name: 'Nhận dạng hậu tố từ loại' }
];

const TEST_SIZES = {
  '12 thì': [20, 20, 20, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25],
  'Cấu trúc câu': [15, 15, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25], // Cấu hình linh hoạt: Test 1(15), 2(15), 3(25), 4(25), 5(25), 6(25), 7(25), 8(25)
  'So sánh': [25, 25, 25, 25, 25, 25, 25, 25],
  'Hoà hợp S-V': [25, 25, 25, 25, 25, 25, 25, 25, 25, 25],
  'Danh từ & Đại từ': [20, 20, 20, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25],
  'Tính từ & Trạng từ': [20, 20, 20, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25],
  'Giới từ': [20, 20, 20, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25],
  'Liên từ': [20, 20, 20, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25],
  'MĐQH': [20, 20, 20, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25],
  'Nhận dạng hậu tố': [30, 30, 30, 30, 30, 30, 30, 30]
};
...
function openExplanation(index) {
  ...
  document.getElementById('modal-reason').innerHTML = parseMarkdown(q.explanation_reason);
  document.getElementById('modal-grammar').innerHTML = parseMarkdown(`${q.grammar_type}: ${q.explanation_grammar}`);
  document.getElementById('modal-translation').innerHTML = parseMarkdown(q.translation);
